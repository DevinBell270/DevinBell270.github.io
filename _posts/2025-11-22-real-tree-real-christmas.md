...
This year, we decided to go with a larger 7ft tree and picked the widest one they had in that range. I love how full the tree looks, we can stack so many ornaments on it. Next year, we will have to get more lights to cover such a big tree, but I love the way it turned out.

![Christmas tree at Creekside Garden & Nursery]({{ '/assets/images/2025-11-22-real-tree-real-christmas/realtree.webp' | relative_url }})

![Our decorated 7ft Christmas tree]({{ '/assets/images/2025-11-22-real-tree-real-christmas/realtree-detail.webp' | relative_url }})
